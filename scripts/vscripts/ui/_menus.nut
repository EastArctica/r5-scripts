...
void function InitMenus()
{
	...
	AddMenu( "AboutGameModeMenu", $"resource/ui/menus/about_game_mode.menu", InitAboutGameModeMenu )
		...
		AddMenu( "ArenasReportMenu", $"resource/ui/menus/arenas_report.menu", InitArenasReportMenu )
	...
	AddMenu( "PrivateMatchGamemodeSelectDialog", $"resource/ui/menus/dialog_gamemode_select_private_match.menu", InitPrivateMatchGamemodeSelectDialog )
		...
		AddMenu( "ControlSpawnSelector", $"resource/ui/menus/control_respawn_menu.menu", InitControlSpawnMenu )
	...
	if( GetConVarBool( "battlepass_expansion_enabled" ) )
		...
		AddMenu( "PassPurchaseMenu", $"resource/ui/menus/pass_purchase_old.menu", InitPassPurchaseMenu )
	...
	if( GetConVarBool( "battlepass_expansion_enabled" ) )
		...
		AddMenu( "BattlePassAboutPage1", $"resource/ui/menus/dialogs/battle_pass_about_1_old.menu", InitAboutBattlePass1Dialog )
	...
	AddMenu( "TeamsScoreboardReportMenu", $"resource/ui/menus/teams_scoreboard_report.menu", InitTeamsScoreboardReportMenu )
	...
	AddMenu( "AboutGamemodeDialog", $"resource/ui/menus/dialog_about_gamemode.menu", InitAboutGamemodeDialog )
