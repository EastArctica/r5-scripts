...
void function ConfigureClubChatButton( ClubEvent chatEvent, var button, bool isNewEventRule = false )
{
	...
	if(chatEvent.eventType == CLUB_EVENT_USER_AUTOBLOCKED){
		RuiSetBool(buttonRui, "isAdminMsg", true)
		string ruiStyle = chatstring.slice(1,3)
		chatstring = chatstring.slice(3)
		RuiSetInt(buttonRui, "ruiStyle", ruiStyle.tointeger())
	}
