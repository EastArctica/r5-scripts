...
void function InitVCPopUp( var newMenuArg )
{
	...
	{
		var vcButton = Hud_GetChild( s_vc.vcPopUpPanel, "VCButton" + (index + 1) )
...
void function InitOffers()
{
	...
	for ( int col = 0; col < 5; col++ )
	{
		...
		int storeLocation = Hud_GetHudName( s_offers.offersPanel ) == "SpecialsPanel" ? eStoreLocation.SPECIALS : eStoreLocation.SHOP
