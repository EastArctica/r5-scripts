...
void function UpdateArenasReportMenu()
{
	...
	RunClientScript( "UICallback_ReportMenu_BindTeamHeader", Hud_GetChild( file.menu, "MyTeamHeader" ), true, Hud_GetWidth(Hud_GetChild( file.menu, "MyTeamHeader" )), false )
	RunClientScript( "UICallback_ReportMenu_BindTeamHeader", Hud_GetChild( file.menu, "EnemyTeamHeader" ), false, Hud_GetWidth(Hud_GetChild( file.menu, "EnemyTeamHeader" )), false )

	array<var> buttons = GetPanelElementsByClassname( file.menu, "ReportMenuMyTeam" )

	foreach ( b in buttons )
	{
		RunClientScript( "UICallback_ReportMenu_BindTeamRow", b, true, Hud_GetWidth(b), false )
	}
	...
	foreach ( b in buttons )
	{
		RunClientScript( "UICallback_ReportMenu_BindTeamRow", b, false, Hud_GetWidth(b), false )
	}
