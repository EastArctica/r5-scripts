...
void function SquadSummaryOnOpenPanel( var panel )
{
	...
	foreach ( cardElem in file.panelData[ panel ].gCards )
	{
		...
		RunClientScript( "UICallback_PopulateClientGladCard", panel, cardElem, muteButton, nullMutePingButton, reportButton, blockButton, nullInviteButton, overlayButton, nullDisconnectedElem, i, ClientTime(), presentation )
