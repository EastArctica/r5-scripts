...
void function OnShowLegendPage( var panel )
{
	...
	RunClientScript( "UICallback_PopulateClientGladCard", panel, elem, nullMuteButton, nullMutePingButton, nullReportButton, nullBlockButton, nullInviteButton, nullOverlayButton, nullDisconnectedElem, emptyTeamMemberIndex, ClientTime(), eGladCardPresentation.FRONT_CLEAN )
