...
void function OnShowSquad( var panel )
{
	...
	foreach ( elem in file.squadPanels[ panel ].gCards )
	{
		...
		RunClientScript( "UICallback_PopulateClientGladCard", panel, elem, muteButton, mutePingButton, reportButton, blockButton, nullInviteButton, overlayButton, disconnectedElem, i, ClientTime(), eGladCardPresentation.FULL_BOX )
